...
const SEED_DISHES = [
  ...
  ['Котлети з яловичого фаршу зі шпинатом + нутове пюре', 'Вечеря', '', '', '', ''],
  ['Теплий салат з яловичиною, шпинатом і гарбузовим насінням', 'Вечеря', '', '', '', ''],
  ['Яловичі реберця запечені з квасолею в томатному соусі', 'Вечеря', '', '', '', ''],
  ['Яловичина на грилі, теплий салат з нутом, шпинатом і гранатом', 'Вечеря', '', '', '', ''],
  ['Яловичий гуляш з квасолею, морквою і паприкою', 'Вечеря', '', '', '', ''],
